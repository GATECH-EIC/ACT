...
from transformers import LlamaForCausalLM, LlamaTokenizer, AutoTokenizer, AutoModel, AutoModelForCausalLM, MistralForCausalLM
from transformers.models.llama.modeling_llama import apply_rotary_pos_emb, repeat_kv, rotate_half
from .augment_index import aug_classification_mistral
...
def atten_process_eval(attention_map, index=None):
    ...
    head_indices = aug_classification_mistral[index-2]
...
def atten_aug_forward_eval_mistral(
    self,
    ...
    **kwargs,
        ...
        if signal in range(2, 32):
            attn_weights = atten_process_eval(attn_weights, signal)
